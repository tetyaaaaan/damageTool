...
const SHARD_ID = "weapons-primary-numeric-shard02";
const SHARD_SIZE = 100;
const SHARD_OFFSET = 100;
const FRONTIER_ID = "weapons-primary-numeric-shard02-independent-field-frontier-7.0";
const FRONTIER_POLICY_ID = "genshin-7.0-weapon-primary-numeric-shard-independent-field-frontier";
const EXPECTED_ARTIFACT_SHA256 = "6ee94161af04ceafb0596e764db4d65839ebbf499e6af329211bd7f09f371d69";
const EXPECTED_FIELD_DIGEST = "76f3b3ea1dd00324b4782532b08200ec2450dad4fb8fa3a9159bf7d366845f94";
...
const OUTPUT_PATH = path.join(ROOT, "games", "genshin", "data", "v2", "reviews", "r2-weapon-primary-field-search-shard02.json");
const SCHEMA_PATH = path.join(ROOT, "games", "genshin", "data", "schema", "r2-weapon-primary-field-search-shard02.schema.json");
...
function buildAudit() {
    ...
    const frontier = {
        ...
        candidateIds,
        searchScope: "Exact numeric-match weapon candidates ranked 101-200 after excluding all numeric candidates whose current queue consumerStatus is notApplicable; persisted primary raw pins, official HoYoWiki capture, finite provider substitution assessments, finite 30-candidate weapon ledger, source catalog policy, and candidate-specific repository evidence only. No network fetch or raw refetch.",
    ...
    const artifact = {
        ...
        scope: {
            shardId: SHARD_ID,
            selection: "primary comparison records with status numericAgreementOnlyNotSemanticIdentity and current queue consumerStatus=notApplicable, localeCompare candidateId ascending, offset 100, next 100",
            candidateCount: candidateIds.length,
...
function decisionForWeaponTask(task, candidate, audit, artifactRef) {
    ...
    return {
        id: `r2-weapon-primary-shard02-deferral:${task.candidateId}`,
...
function isAllowedWeaponShard02ExternalEvidenceWait(task, audit) {
...
function prepareRegistry({ audit = null, compareCurrent = null, sourceRegistry = null } = {}) {
    ...
    for (const id of candidateIds) {
        ...
        if (!isAllowedWeaponShard02ExternalEvidenceWait(baseTask, audit)) {
    ...
    const registry = {
        ...
        policyId: work.POLICY,
        targetGameVersion: TARGET_GAME_VERSION,
        note: "In-memory exact weapon primary shard02 preview; not persisted.",
        decisions,
    ...
    const combinedExpectedKpi = {
        ...
        addedCandidateShards: { behaviorSpecShard01: 100, weaponPrimaryShard01: 100, weaponPrimaryShard02: 100 },
...
module.exports = {
    ...
    SHARD_OFFSET,
    REQUIRED_CLAIMS,
    isAllowedWeaponShard02ExternalEvidenceWait,
    SHARD_SIZE,
    stableJson,
    digest,
    buildAudit,
